...
echo "30 * * * * cd /home/matrix/matrix-army/iseeiape-website && node content/automation/cron-scheduler-v2.js --step data >> /tmp/iseeiape-data.log 2>&1" >> "$TEMP_CRON"
echo "" >> "$TEMP_CRON"

echo "# Content Generation - Run every 4 hours" >> "$TEMP_CRON"
echo "# Generates fresh content based on latest market data" >> "$TEMP_CRON"
echo "0 */4 * * * cd /home/matrix/matrix-army/iseeiape-website && node content/automation/cron-scheduler-v2.js --step content >> /tmp/iseeiape-content.log 2>&1" >> "$TEMP_CRON"
echo "" >> "$TEMP_CRON"

echo "# Twitter Posting - Run every 30 minutes" >> "$TEMP_CRON"
echo "# Checks for scheduled posts and posts them" >> "$TEMP_CRON"
echo "*/30 * * * * cd /home/matrix/matrix-army/iseeiape-website && node content/automation/cron-scheduler-v2.js --step twitter >> /tmp/iseeiape-twitter.log 2>&1" >> "$TEMP_CRON"
echo "" >> "$TEMP_CRON"
...
echo "0 3 * * * cd /home/matrix/matrix-army/iseeiape-website && node content/automation/cron-scheduler-v2.js --step articles >> /tmp/iseeiape-articles.log 2>&1" >> "$TEMP_CRON"
echo "" >> "$TEMP_CRON"
...
echo "0 2 * * * cd /home/matrix/matrix-army/iseeiape-website && node content/automation/cron-scheduler-v2.js --step health >> /tmp/iseeiape-health.log 2>&1" >> "$TEMP_CRON"
echo "0 */6 * * * cd /home/matrix/matrix-army/iseeiape-website && node content/automation/cron-scheduler-v2.js --step health >> /tmp/iseeiape-health.log 2>&1" >> "$TEMP_CRON"
echo "" >> "$TEMP_CRON"
...
echo "0 */2 * * * cd /home/matrix/matrix-army/iseeiape-website && node neo-crypto/scripts/trading-signal-generator-enhanced.js >> /tmp/iseeiape-signals.log 2>&1" >> "$TEMP_CRON"
echo "" >> "$TEMP_CRON"
